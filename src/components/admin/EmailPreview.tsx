    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          style={{ boxShadow: "0 30px 100px rgba(0,0,0,0.5), 0 0 60px rgba(49,107,255,0.15)" }}
        >
          ...
          <div className="px-6 py-4 border-b border-white/10 flex justify-between items-center text-sm">
            <div className="flex flex-col gap-1">
              ...
              <span className="text-white/45">Subject: <strong className="text-white">You've been approved — Khinext '26 AI Expo</strong></span>
            </div>
          ...
          <div className="p-6 md:p-8">
            <div className="mx-auto max-w-[600px] rounded-xl overflow-hidden bg-white text-[#0F1626] shadow-2xl">
              <div className="relative isolate overflow-hidden px-9 pt-9 pb-14 text-white" style={{ background: "#040B1C" }}>
                <div
                  aria-hidden="true"
                  className="absolute inset-0 -z-10"
                  style={{
                    background:
                      "radial-gradient(ellipse 60% 80% at 80% 0%, rgba(49,107,255,0.5) 0%, transparent 60%), radial-gradient(ellipse 60% 80% at 20% 100%, rgba(49,107,255,0.32) 0%, transparent 60%)",
                  }}
                />
                ...
                <p className="text-[11px] uppercase font-bold text-[#8FAFFF] tracking-widest mb-3.5">AI Expo '26 · Application Update</p>
                <p className="font-display text-3xl md:text-4xl font-extrabold leading-tight m-0" style={{ letterSpacing: "-0.025em" }}>
                  You've been <em className="text-[#4A8FFF] font-extrabold" style={{ fontStyle: "italic" }}>approved.</em>
                </p>
              </div>

              <div className="px-9 py-9 text-[15px] leading-relaxed text-[#2A3245]">
                <p className="m-0 mb-4">Hi <strong className="text-[#040B1C]">{submission.full_name}</strong>,</p>
                <p className="m-0 mb-4">
                  Your submission to the <strong className="text-[#040B1C]">Khinext '26 AI Expo</strong> has been reviewed and approved by the curation team.
                </p>
                <p className="m-0 mb-4">
                  Your project, <strong className="text-[#040B1C]">"{submission.project}"</strong>, has been selected for a live demo booth at the event in Karachi.
                </p>
                <div className="my-5 rounded-xl border border-[#DEE6FA] bg-[#F4F7FE] p-5">
                  {[
                    ...
                    <div key={row.k} className="flex justify-between py-2 text-[13px] border-b border-dashed border-[#DEE6FA] last:border-b-0">
                      ...
                      <span className="text-[#040B1C] font-bold">{row.v}</span>
                    </div>
                  ))}
                </div>
                <p className="m-0 mb-4">
                ...
                <div className="my-5">
                  <a
                    ...
                    className="inline-block bg-[#316BFF] text-white font-medium text-sm px-7 py-3.5 rounded-full no-underline"
                  >
                    View your submission →
                  </a>
                </div>
                <div className="mt-1.5 pt-4 border-t border-[#E4EAF6] text-[13px] text-[#6C7894]">
                  <p className="m-0">With excitement,<br /><strong className="text-[#040B1C]">The Khinext '26 Team</strong></p>
                  <p className="m-0 mt-1 text-[12px]">Pakistan's first multi-domain AI Summit · Karachi, 2026</p>
                </div>
              </div>

              <div className="bg-[#F4F7FE] px-9 py-5 text-center text-[12px] text-[#6C7894]">
                © 2026 Khinext. Pakistan's first multi-domain AI Summit.
              </div>
            </div>
          </div>
