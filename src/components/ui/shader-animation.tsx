...
export function ShaderAnimation() {
  ...
  useEffect(() => {
    ...
    // Khinext blue-toned concentric ring shader
    // Base palette: #02040A (ink) → #316BFF (khi-blue) → #8FAFFF (soft blue-white)
    const fragmentShader = `
      ...
      void main(void) {
        ...
        // Map luminance → Khinext blue palette
        ...
        vec3 c0 = vec3(0.008, 0.016, 0.039); // ink-black
        vec3 c1 = vec3(0.059, 0.145, 0.376); // deep navy
        vec3 c2 = vec3(0.192, 0.420, 1.000); // khi-blue
        vec3 c3 = vec3(0.561, 0.686, 1.000); // soft blue-white
  ...
  return (
    <div
      ...
      style={{ background: "#02040A", overflow: "hidden" }}
    />
  )
}
