...
export const metadata: Metadata = {
  title: "Card Generator Closed — Khinext '26",
  description: "The Khinext '26 digital card generator is no longer available. Stay tuned for Khinext '27.",
};
...
export default function CardGeneratorPage() {
  return (
    <>
      ...
      >
        The Khinext &apos;26 digital attendance card is no longer available. A new card for Khinext &apos;27 will launch with the next edition.
      </PageHero>
        ...
        <Reveal>
          <div className="max-w-[560px] mx-auto rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-8 md:p-12 text-center">
            ...
            <p className="text-white/50 text-sm md:text-base leading-relaxed mb-8">
              The Khinext &apos;26 AI Summit has concluded. The digital attendance card for the next edition will be available when Khinext &apos;27 registration opens in 2026.
            </p>
