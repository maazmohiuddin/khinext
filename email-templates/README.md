...
await sendKhinextEmail({
  ...
  subject: "Khinext '26 — venue & agenda update",
...
| `signature` | no | default: "The Khinext '26 Team" |
...
1. Verify `khinext.com` as a domain in Resend (DNS records) — or use
