# Khinext '26 — Supabase auth email templates

All templates in this folder match the Khinext brand: dark-ink header
...
|---|---|
| Confirm signup            | Confirm your email — Khinext '26 |
| Invite user               | You're invited to Khinext '26 |
| Magic link                | Your magic link to Khinext '26 |
| Reset password            | Reset your Khinext '26 password |
| Change email address      | Confirm your new email — Khinext '26 |
| Reauthentication          | Verify your action — Khinext '26 |
| Password changed          | Your Khinext '26 password was changed |
| Email address changed     | Your Khinext '26 email was changed |
| Phone number changed      | Your Khinext '26 phone number was changed |
...
- **Sender email**: `info@khinext.com`
- **Sender name**: `Khinext '26`
